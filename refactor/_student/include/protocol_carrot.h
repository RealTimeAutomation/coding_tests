/**
 * @file protocol_carrot.h
 * @brief Carrot protocol message serialization and parsing
 * 
 * This module provides functions to parse, serialize, validate, and compute
 * checksums for Carrot protocol messages. The protocol uses a binary format
...
/**
 * @brief Carrot protocol message structure
 */
typedef struct {
...
/**
 * @brief Parses a Carrot protocol message from a buffer
 * 
 ...
 * @example
 *   carrot_message msg;
 *   if (carrot_parse(buffer, buffer_len, &msg)) {
...
/**
 * @brief Serializes a Carrot protocol message to a buffer
 * 
...
/**
 * @brief Validates a Carrot protocol message
 * 
...
/**
 * @brief Computes a checksum for a Carrot protocol message
 * 
 ...
 * 
 * @example
 *   unsigned int sum = carrot_checksum(&msg);
 */
