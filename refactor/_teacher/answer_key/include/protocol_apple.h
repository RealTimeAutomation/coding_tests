/**
 * @file protocol_apple.h
 * @brief Apple protocol message serialization and parsing
 * 
 * This module provides functions to parse, serialize, validate, and compute
 * checksums for Apple protocol messages. The protocol uses a binary format
...
/**
 * @brief Apple protocol message structure
 */
typedef struct {
...
/**
 * @brief Parses an Apple protocol message from a buffer
 * 
 ...
 * @example
 *   apple_message msg;
 *   if (apple_parse(buffer, buffer_len, &msg)) {
...
/**
 * @brief Serializes an Apple protocol message to a buffer
 * 
...
/**
 * @brief Validates an Apple protocol message
 * 
...
/**
 * @brief Computes a checksum for an Apple protocol message
 * 
 ...
 * 
 * @example
 *   unsigned int sum = apple_checksum(&msg);
 */
